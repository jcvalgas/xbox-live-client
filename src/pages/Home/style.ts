...
export const HomeNav = styled.nav`
  ${({ theme }) => css`
    ...
    border-bottom: .2rem solid linear-gradient(${theme.colors.colorBlack}, transparent);
  `}
`;
...
export const SectionAbout = styled.section`
    ${() => css`
        margin-top: -10rem;
        background-image: linear-gradient(rgba(0,0,0, 0.6), rgba(0,0,0, .6)), url(${bgHomeMain});
        background-size: 100%;
